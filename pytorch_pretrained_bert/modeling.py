...
class BertIntermediate(nn.Module):
    def __init__(self, config):
        ...
        if config.binary:
            self.dense = BinaryLinear(config.hidden_size, config.intermediate_size)
        else:
...
class BertOutput(nn.Module):
    def __init__(self, config):
        ...
        if config.binary:
            self.dense = BinaryLinear(config.intermediate_size, config.hidden_size)
        else:
